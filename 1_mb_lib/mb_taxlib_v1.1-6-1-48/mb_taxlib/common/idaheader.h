/*****************************************************************************
File name:   idaheader.h
Description: ��ȡ��IDA SDK���룬ȫ������ṹ���ￄ1�71ￄ1�77
Author:      Zako
Version:     1.0
Date:        2018.10.10
History:
20181010     ��IDA Pro��������ȡͷ�ļ�����
*****************************************************************************/
/*
...
#include <mb_clib/sm234/sm4/sm4.h>
#include <mb_clib/sm234/sm3/sm3.h>
#include <mb_clib/mxml/mxml.h>
#include <mb_clib/mxml/config.h>
#include <mb_clib/mxml/mxml-private.h>
#include <mb_clib/minizip/zip.h>
...
#define RELEASE_SO
#define RELEASE
#define MAX_USB_PORT_NUM    240 
#ifdef DF_OLD_MSERVER
#define MB_TAX_LIB_VERSION	"1.1.6.1"
#else
#define MB_TAX_LIB_VERSION	"1.1.6.1"
#endif
#define MB_TAX_LIB_V_NUM	"48"
#define MB_TAX_LIB_TIME		"2024-01-12"
#if defined(__GNUC__)
...
// myset 20190928
#define __ROL4__(x, s) (((x) << (s)) | ((x) >> (32 - (s))))
#define __ROR4__(x, s) (((x) >> (s)) | ((x) << (32 - (s))))
#define __ROL__(x, s, n) ((x) << (n)) | ((x) >> ((s) - (n)))
#define __ROR__(x, s, n) ((x) >> (n)) | ((x) << ((s) - (n)))
