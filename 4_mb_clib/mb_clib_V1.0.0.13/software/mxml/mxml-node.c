...
mxml_node_t *                                   /* O - New node */
mxmlNewCustom(mxml_node_t *parent,              /* I - Parent node or @code MXML_NO_PARENT@ */
...
mxmlNewXML(const char *version) /* I - Version number to use */
{
    ...
    if (!strcmp(version, "1.0U"))
        snprintf(element, sizeof(element), "?xml version=\"%s\" encoding=\"UTF-8\" ?", "1.0");
    else
        snprintf(element, sizeof(element), "?xml version=\"%s\" encoding=\"GBK\"?",
                 version ? version : "1.0");
...
static void mxml_free(mxml_node_t *node) /* I - Node */
{
    int i; /* Looping var */
    switch (node->type) {
        case MXML_ELEMENT:
