...
mxmlFindElement(mxml_node_t *node,   /* I - Current node */
                ...
                int descend) /* I - Descend into tree - @code MXML_DESCEND@, @code MXML_NO_DESCEND@,
                                or @code MXML_DESCEND_FIRST@ */
{
...
mxmlWalkNext(mxml_node_t *node, /* I - Current node */
             mxml_node_t *top,  /* I - Top node */
             int descend) /* I - Descend into tree - @code MXML_DESCEND@, @code MXML_NO_DESCEND@, or
                             @code MXML_DESCEND_FIRST@ */
{
    if (!node)
        return (NULL);
                             ...
                             @code MXML_DESCEND_FIRST@ */
{
    if (!node || node == top)
        ...
        if (node->prev->last_child && descend) {
            ...
            while (node->last_child) node = node->last_child;
