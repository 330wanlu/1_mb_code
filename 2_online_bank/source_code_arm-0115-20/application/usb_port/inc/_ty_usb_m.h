...
#include <stdlib.h>
#include "tran_data.h"
#include "../manage/process_manage.h"
#include "../linux_sys/mqtt_client.h"
#include "../linux_sys/http.h"
#include "../manage/process_manage.h"
#include "lcd_state.h"
#include "deploy.h"
...
#include "m_server.h"
#include "_devops.h"
#include "_tax_interface.h"

#define ty_usb_m_out(s,arg...)       				log_out("all.c",s,##arg)
...
#define DF_PLATE_CERT_PASSWD_ERR -107
#define DF_PLATE_DEV_PASSWD_ERR -108
#define DF_PLATE_DEV_PASSWD_LOCK -109
...
struct _port_state
{
	...
	int need_up_power; //0非正在上电   1正在上电
	int need_down_power; //0非正在下电   1正在下电
	int ad_repair_check;
...
//服务器连接握手--hello
e_ty_usb_m int fun_client_hello(char *plate_num, char *client_hello, char *errinfo);
//服务器连接认证--auth
...
//获取mqtt连接MD5信息
e_ty_usb_m int function_get_mqtt_connect_data_md5_jude_update(char *server_addr, int *server_port, char *mqtt_uid, char *mqtt_pwd);
//获取mqtt连接证书信息
e_ty_usb_m int function_get_mqtt_connect_data_info_update(char *server_addr, int *server_port, char *mqtt_uid, char *mqtt_pwd);
//更新授权文件
...
static int pack_report_plate_info_json_new_mqtt(char **g_buf, int off_up_flag, char *random,struct _port_state   *state);		//wang 11/9
