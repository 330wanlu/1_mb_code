...
int get_usbshare_status_new(char *server_ip, int server_port, char *out_ter_info)
{
	...
	if((s_client = socket_connect(file_setting[i].terminal_ip,file_setting[i].data_port,file_setting[i].remote_ip,file_setting[i].remote_dataport,3000)) == SOCKET_ERROR)
	{
