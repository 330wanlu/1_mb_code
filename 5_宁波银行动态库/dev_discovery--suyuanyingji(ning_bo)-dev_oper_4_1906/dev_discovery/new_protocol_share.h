...
extern int get_usbshare_status_new(char *server_ip, int server_port, char *out_ter_info);
...
// extern int restart_terminal_nb(char *server_ip, int server_port);
...
extern int get_upgrade_net_intranet(char *server_ip, int server_port,char *intranet_ip ,char *external_ip, char *out_ter_info, char *ter_id, int notice_type,char *url_buff);

//extern int get_upgrade_net_intranet(char *server_ip, int server_port,char *intranet_ip ,char *external_ip, char *out_ter_info, char *ter_id, int notice_type,char *url_buff,int size);
